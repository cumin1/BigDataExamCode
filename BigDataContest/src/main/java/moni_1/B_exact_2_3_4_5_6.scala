...
//
//    spark.sql("create table ods_ds_hudi.base_province using hudi location 'hdfs://bigdata1:9000/user/hive/warehouse/ods_ds_hudi.db/base_province'")
...
//      .save("hdfs://bigdata1:9000/user/hive/warehouse/ods_ds_hudi.db/base_region")
    ...
    spark.sql("create table ods_ds_hudi.base_region using hudi location 'hdfs://bigdata1:9000/user/hive/warehouse/ods_ds_hudi.db/base_region'")
    ...
    spark.sql("create table ods_ds_hudi.order_info using hudi location 'hdfs://bigdata1:9000/user/hive/warehouse/ods_ds_hudi.db/order_info'")
    ...
    spark.sql("create table ods_ds_hudi.order_detail using hudi location 'hdfs://bigdata1:9000/user/hive/warehouse/ods_ds_hudi.db/order_detail'")
